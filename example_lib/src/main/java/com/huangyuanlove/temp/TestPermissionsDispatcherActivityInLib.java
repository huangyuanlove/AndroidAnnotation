...
@RuntimePermissions
public class TestPermissionsDispatcherActivityInLib extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.test_runtime_permission).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TestPermissionsDispatcherActivityInLibPermissionsDispatcher

                .testRuntimePermissionOnClickWithPermissionCheck(TestPermissionsDispatcherActivityInLib.this,v);
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        TestPermissionsDispatcherActivityInLibPermissionsDispatcher.onRequestPermissionsResult(this,requestCode,grantResults);
    }
